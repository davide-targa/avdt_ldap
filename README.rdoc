...
Just add a config file named ldap.yml in config/initializers.rb:
If you prefer you can change default config file name by setting +ldap_config_file+  configuration parameter.
<br/>For example, inside the avdt_ldap initializer:
